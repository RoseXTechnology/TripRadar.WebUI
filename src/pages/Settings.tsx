...
import { User, Mail, Lock, Bell, Shield, Plug, Camera, Edit3, Check, X, AlertTriangle, Trash2, Plus, Eye, EyeOff, Chrome, Github, Smartphone, Globe, Moon, Sun, Download, ExternalLink, Settings as SettingsIcon, ChevronRight, Save, RefreshCw, Sparkles, Palette, Monitor, LogOut, Key, Database, Zap, BarChart, CreditCard, Link as LinkIcon, Search, Bot, Utensils, Home, Briefcase, Languages, Armchair as Wheelchair, Baby, PawPrint, Bus, Car, Plane, Hotel, Bed, DollarSign, Coffee, Wine } from 'lucide-react';
...
export default function Settings() {
  ...
  const renderPreferencesSection = () => (
    <div className="space-y-8">
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-6 flex items-center space-x-2">
          <Wheelchair className="h-5 w-5 text-primary-600 dark:text-primary-400" />
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-6 flex items-center space-x-2">
          ...
          <span>Activity Time Preference</span>
        </h3>
