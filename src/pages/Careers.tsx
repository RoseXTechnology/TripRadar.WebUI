  ...
  const testimonials = [
    {
      ...
      quote: "The technical challenges here are incredible. I'm constantly learning and working with cutting-edge technology that impacts millions of travelers.",
    ...
    },
    {
      ...
      quote: "The company culture is amazing - truly remote-first with incredible support for work-life balance. Plus, seeing our APIs power real travel experiences is so rewarding.",
      image: "https://images.pexels.com/photos/1181686/pexels-photo-1181686.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&dpr=1"
    },
    {
      name: "James Wilson",
      role: "DevOps Engineer",
      quote: "Working with modern infrastructure and the latest tools is a dream. The team is supportive, and we're building something that really matters.",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className={`text-center transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-4xl mx-auto mb-12 leading-relaxed">
              Join our passionate team of developers, engineers, and travel enthusiasts creating 
              APIs that power the next generation of travel applications.
            </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="lg:col-span-2">
                    <div className="flex flex-wrap items-center gap-4 mb-4">
                      ...
                      <span className={`px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r ${position.gradient} text-white`}>
                        {position.department}
                      </span>
                    </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {position.requirements.map((req, idx) => (
                            <span key={idx} className="bg-gray-100 dark:bg-gray-600 text-gray-700 dark:text-gray-300 px-3 py-1 rounded-full text-sm">
                              {req}
                            </span>
                          ))}
                        </div>
                ...
                {selectedPosition === position.id && (
                  <div className="mt-6 p-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl animate-slide-up">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 mb-4">
                      We're looking for a talented {position.title} to join our growing team. In this role, you'll have the opportunity to work on cutting-edge travel technology that impacts millions of users worldwide.
                    </p>
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmitApplication} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className={`w-full px-4 py-3 border rounded-lg bg-white dark:bg-gray-700 ${
                      formErrors.resume ? 'border-red-300 dark:border-red-700' : 'border-gray-300 dark:border-gray-600'
                    }`}>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-none bg-white dark:bg-gray-700 text-gray-900 dark:text-white ${
                        formErrors.coverLetter ? 'border-red-300 dark:border-red-700' : 'border-gray-300 dark:border-gray-600'
                      }`}
                  ...
                  <div className="flex items-start space-x-3 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                    ...
                    <p className="text-sm text-yellow-700 dark:text-yellow-300">
                      By submitting this application, you consent to our processing of your data for recruitment purposes. See our <a href="/privacy" className="underline hover:text-yellow-800 dark:hover:text-yellow-200">Privacy Policy</a> for details.
                    </p>
                  </div>
      ...
      <section className="py-24 bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-12 max-w-2xl mx-auto">
            Don't see a perfect fit? We're always interested in talking to talented people. 
