...
export default function TokenUsage() {
  ...
  const [tokenUsageData, setTokenUsageData] = useState<TokenUsage[]>([
    { date: '2025-02-15', tokens: 1250, operation: 'Flight Search', category: 'search' },
    { date: '2025-02-15', tokens: 850, operation: 'AI Trip Planning', category: 'ai' },
    { date: '2025-02-14', tokens: 620, operation: 'Hotel Search', category: 'search' },
    { date: '2025-02-14', tokens: 430, operation: 'Weather API', category: 'api' },
    { date: '2025-02-13', tokens: 1100, operation: 'AI Chat Assistant', category: 'ai' },
    { date: '2025-02-13', tokens: 780, operation: 'Currency Conversion', category: 'api' },
    { date: '2025-02-12', tokens: 950, operation: 'Flight Search', category: 'search' },
    { date: '2025-02-12', tokens: 520, operation: 'Local Recommendations', category: 'ai' },
    { date: '2025-02-11', tokens: 1300, operation: 'AI Chat Assistant', category: 'ai' },
    { date: '2025-02-11', tokens: 480, operation: 'Event Search', category: 'search' },
    { date: '2025-02-10', tokens: 720, operation: 'Budget Analysis', category: 'ai' },
    { date: '2025-02-10', tokens: 630, operation: 'Map Rendering', category: 'api' },
    { date: '2025-02-09', tokens: 890, operation: 'Flight Search', category: 'search' },
    { date: '2025-02-09', tokens: 760, operation: 'AI Trip Planning', category: 'ai' },
  ]);
  ...
  const totalTokensUsed = timeframe === 'daily' 
    ? tokenUsageData.reduce((sum, item) => sum + item.tokens, 0)
    : monthlyData[0]?.tokens || 0;
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300 pt-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 animate-slide-up">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Monitor your API token consumption and usage patterns
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Usage This {timeframe === 'daily' ? 'Week' : 'Month'}</h3>
              ...
              <div className="mb-4">
                <div className="flex justify-between items-center mb-2">
                  <div className="text-sm text-gray-600 dark:text-gray-400">
                    <span className="font-medium text-gray-900 dark:text-white">{totalTokensUsed.toLocaleString()}</span> of {currentLimit.toLocaleString()} tokens
                  </div>
                  <div className={`text-sm font-medium ${
                    percentageUsed >= 90 ? 'text-red-600 dark:text-red-400' :
                    percentageUsed >= 75 ? 'text-yellow-600 dark:text-yellow-400' :
        ...
        {/* Usage Chart */}
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-sm mb-8 animate-slide-up" style={{ animationDelay: '0.2s' }}>
        ...
        {/* Usage History */}
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-sm animate-slide-up" style={{ animationDelay: '0.3s' }}>
                    ...
                    <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center space-x-2">
                          <div className={`p-1 rounded-full ${
                            item.category === 'search' ? 'bg-blue-100 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' :
                            item.category === 'ai' ? 'bg-purple-100 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400' :
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-2 py-1 text-xs rounded-full ${
                          item.category === 'search' ? 'bg-blue-100 dark:bg-blue-900/20 text-blue-800 dark:text-blue-300' :
                          item.category === 'ai' ? 'bg-purple-100 dark:bg-purple-900/20 text-purple-800 dark:text-purple-300' :
        ...
        {user?.subscription !== 'enterprise' && (
          <div className="mt-8 bg-gradient-to-r from-primary-600 to-blue-700 rounded-2xl p-8 text-white text-center animate-slide-up" style={{ animationDelay: '0.4s' }}>
