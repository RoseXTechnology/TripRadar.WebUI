  ...
  const values = [
    {
      ...
      detail: "We constantly explore new technologies and methodologies to deliver cutting-edge solutions that transform how people experience travel.",
    ...
    },
    {
      ...
      detail: "Our robust infrastructure ensures your applications run smoothly with minimal downtime, backed by comprehensive monitoring and redundancy.",
    ...
    },
    {
      ...
      detail: "We implement industry-leading security practices, including end-to-end encryption, regular audits, and compliance with international standards.",
    ...
    },
    {
      ...
      detail: "We design our APIs with developers in mind, providing comprehensive documentation, SDKs, and tools that make integration seamless.",
    ...
    },
    {
      ...
      detail: "Our platform aggregates data from 200+ countries, ensuring you have access to accurate, localized information wherever your users travel.",
    ...
    },
    {
      ...
      detail: "Our real-time data processing ensures your applications always have the most current information, from flight prices to weather conditions.",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className={`text-center transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-white/60 max-w-4xl mx-auto mb-12 leading-relaxed">
              We're building the most comprehensive travel and location intelligence platform 
              for developers and businesses worldwide, making travel data accessible, reliable, and powerful.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 text-lg text-gray-600 dark:text-white/60 leading-relaxed">
                <p>
                  Founded in 2023, our platform was born from a simple observation: travel data was 
                  fragmented, unreliable, and difficult to access. Developers were spending countless 
                  hours integrating multiple APIs, dealing with inconsistent data formats, and 
                  managing complex authentication systems.
                </p>
                <p>
                  We set out to change that. Our mission is to democratize access to comprehensive 
                  travel and location data, providing developers with a single, powerful platform 
                  that handles the complexity so they can focus on building amazing experiences.
                </p>
                <p>
                  Today, we serve thousands of developers worldwide, powering everything from 
                  startup travel apps to enterprise booking platforms. Our commitment to reliability, 
                  security, and developer experience drives everything we do.
                </p>
              </div>
            </div>
            <div className="relative">
              <div className="bg-gradient-to-br from-blue-500/20 to-purple-600/20 backdrop-blur-xl border border-blue-500/30 rounded-3xl p-8 text-gray-900 dark:text-white">
                ...
                <p className="text-lg leading-relaxed mb-6 text-gray-700 dark:text-white/80">
                  To become the global standard for travel and location intelligence, 
                  enabling developers to create the next generation of travel experiences 
                  that are more personalized, efficient, and accessible than ever before.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {values.map((value, index) => (
              ...
              >
                <div className={`inline-flex p-4 rounded-2xl bg-gradient-to-br ${value.gradient} mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                ...
                <p className="text-gray-600 dark:text-white/60 mb-4 font-medium">
                  {value.description}
                </p>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 dark:text-white/60 max-w-3xl mx-auto">
              Passionate experts from leading tech companies, united by our mission to 
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className={`text-3xl md:text-5xl font-bold mb-2 transition-all duration-300 ${
                  actualTheme === 'dark'
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-white/60 mb-12 max-w-2xl mx-auto">
            Join thousands of developers who trust our platform to power their travel applications. 
            Start building today with our comprehensive APIs and world-class support.
          </p>
