...
const Features = () => {
  ...
  const features = [
    {
      ...
      features: ["OAuth2 + PKCE authentication", "Secure registration & password reset", "User tiers & role management", "Profile customization"],
  ...
  const integrations = [
    { name: "Google Services", description: "Maps, Places, Flights & Hotels", icon: "🌐", gradient: "from-blue-400 to-blue-600", status: "Connected" },
    { name: "Stripe", description: "Payment processing & subscriptions", icon: "💳", gradient: "from-purple-400 to-purple-600", status: "Connected" },
    { name: "OpenWeatherMap", description: "Global weather data & forecasts", icon: "🌤️", gradient: "from-orange-400 to-orange-600", status: "Connected" },
    { name: "Keycloak", description: "Identity & access management", icon: "🔐", gradient: "from-blue-400 to-indigo-600", status: "Connected" },
    { name: "MailKit", description: "Email delivery & notifications", icon: "📧", gradient: "from-red-400 to-red-600", status: "Connected" },
    { name: "SerpApi", description: "Search engine results & data", icon: "🔍", gradient: "from-green-400 to-green-600", status: "Connected" },
    { name: "Open Charge Map", description: "EV charging station data", icon: "⚡", gradient: "from-cyan-400 to-cyan-600", status: "Connected" },
    { name: "UniRateApi", description: "Currency exchange rates", icon: "💰", gradient: "from-yellow-400 to-yellow-600", status: "Connected" },
    { name: "Calendarific", description: "Global holidays & events", icon: "📅", gradient: "from-indigo-400 to-indigo-600", status: "Connected" },
    { name: "OpenTripMap", description: "Tourist attractions & POIs", icon: "🗺️", gradient: "from-teal-400 to-teal-600", status: "Connected" },
    { name: "Transitland", description: "Public transport data", icon: "🚌", gradient: "from-emerald-400 to-emerald-600", status: "Connected" }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-white/60 max-w-4xl mx-auto mb-12 leading-relaxed">
              Build extraordinary travel experiences with our comprehensive suite of APIs. 
              From flight search to weather data, we provide everything you need to create 
              the next generation of travel applications.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 dark:text-white/60 max-w-3xl mx-auto">
              Our platform provides a complete toolkit for developers to create sophisticated 
              travel and location-based applications with enterprise-grade reliability.
            </p>
          </div>
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 dark:text-white/60 max-w-3xl mx-auto">
              Access comprehensive travel data through our RESTful APIs with real-time responses 
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 dark:text-white/60 max-w-3xl mx-auto">
              Connect with leading travel and technology providers to access comprehensive 
              data and services through a single, unified API.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {integrations.map((integration, index) => (
              ...
              >
                ...
                {/* Icon */}
                <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${integration.gradient} flex items-center justify-center text-2xl mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                  {integration.icon}
                </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className={`text-4xl md:text-6xl font-bold mb-2 transition-all duration-300 ${
                  actualTheme === 'dark'
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-white/10 rounded-3xl p-12 hover-glow-${actualTheme}">
            ...
            <p className="text-xl text-gray-600 dark:text-white/60 mb-12 max-w-2xl mx-auto">
              Start building with our comprehensive APIs today. Get access to real-time travel data, 
              powerful search capabilities, and enterprise-grade infrastructure.
            </p>
