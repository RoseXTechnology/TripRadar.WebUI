      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-8 mb-8">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            TripRadar Inc. ("us", "we", or "our") uses cookies on the TripRadar website and mobile application (the "Service"). By using the Service, you consent to the use of cookies.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  You can set your browser to refuse all cookies or to indicate when a cookie is being sent. Check your browser's help pages for instructions:
                </p>
                <ul className="list-disc pl-6 space-y-1 text-sm text-gray-600 dark:text-gray-400 mt-2">
                  ...
                  <li><a href="https://support.mozilla.org/en-US/kb/enhanced-tracking-protection-firefox-desktop" target="_blank" rel="noopener noreferrer" className="text-primary-600 dark:text-primary-400 hover:underline">Mozilla Firefox</a></li>
                  <li><a href="https://support.apple.com/guide/safari/manage-cookies-and-website-data-sfri11471/mac" target="_blank" rel="noopener noreferrer" className="text-primary-600 dark:text-primary-400 hover:underline">Safari</a></li>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm text-gray-600 dark:text-gray-400 mt-2">
                  <li><a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" className="text-primary-600 dark:text-primary-400 hover:underline">Google Analytics Opt-out Browser Add-on</a></li>
                  <li><a href="https://www.networkadvertising.org/choices/" target="_blank" rel="noopener noreferrer" className="text-primary-600 dark:text-primary-400 hover:underline">Network Advertising Initiative Opt-out Tool</a></li>
                  <li><a href="https://www.youronlinechoices.com/" target="_blank" rel="noopener noreferrer" className="text-primary-600 dark:text-primary-400 hover:underline">Your Online Choices (EU)</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-8 mb-8">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-6">
            You can manage your cookie preferences directly on our website. Use the controls below to customize which types of cookies you allow:
          </p>
            ...
            <div className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-600 rounded-xl">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">Required for the website to function properly</div>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-600 rounded-xl">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">Enable enhanced features and personalization</div>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-600 rounded-xl">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">Help us improve our website by collecting anonymous usage data</div>
                </div>
              </div>
              <button className="relative inline-flex h-6 w-11 items-center rounded-full bg-gray-200 dark:bg-gray-600">
                <span className="inline-block h-4 w-4 transform translate-x-1 rounded-full bg-white"></span>
            ...
            <div className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-600 rounded-xl">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">Allow us to deliver personalized advertisements</div>
                </div>
              </div>
              <button className="relative inline-flex h-6 w-11 items-center rounded-full bg-gray-200 dark:bg-gray-600">
                <span className="inline-block h-4 w-4 transform translate-x-1 rounded-full bg-white"></span>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <a href="mailto:privacy@tripradar.io" className="text-primary-600 dark:text-primary-400 hover:underline ml-2">
