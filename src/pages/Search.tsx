...
const mockHotels = [
  ...
  },
  {
    ...
    image: 'https://images.pexels.com/photos/1134176/pexels-photo-1134176.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&dpr=1',
...
const mockPlaces = [
  {
    id: 'PL1',
    name: 'Burj Khalifa',
    image: 'https://images.pexels.com/photos/162031/dubai-tower-arab-khalifa-162031.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&dpr=1',
    category: 'Landmark',
    rating: 4.7,
    reviews: 15420,
  ...
  },
  {
    id: 'PL2',
    name: 'Dubai Mall',
    image: 'https://images.pexels.com/photos/5746087/pexels-photo-5746087.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&dpr=1',
    category: 'Shopping',
    rating: 4.8,
    reviews: 12350,
  ...
  },
  {
    id: 'PL3',
    name: 'Palm Jumeirah',
    image: 'https://images.pexels.com/photos/2044434/pexels-photo-2044434.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&dpr=1',
    category: 'Landmark',
    rating: 4.6,
    reviews: 8920,
          ...
          return (
            <div className="space-y-6">
              ...
              {mockFlights.map((flight) => (
                <div key={flight.id} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 hover:shadow-md transition-all duration-200 animate-slide-up">
                  <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    ...
                    <div className="flex-1 grid grid-cols-3 gap-4">
                      <div className="text-center">
                        <div className="text-lg font-semibold text-gray-900 dark:text-white">{flight.departure.time}</div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {mockHotels.map((hotel) => (
                  <div key={hotel.id} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden hover:shadow-md transition-all duration-200 animate-slide-up">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {mockPlaces.map((place) => (
                  <div key={place.id} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden hover:shadow-md transition-all duration-200 animate-slide-up">
                    <div className="relative h-48">
                      <img 
                        src={place.image} 
                        alt={place.name} 
            ...
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-8 text-center">
              <div className="text-gray-500 dark:text-gray-400">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6">
                  Enter your search criteria above to find {searchCategories.find(c => c.id === activeCategory)?.name.toLowerCase()}.
                </p>
                <button 
    ...
    return (
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-8">
        <div className="text-center text-gray-500 dark:text-gray-400">
          ...
          <p className="text-gray-600 dark:text-gray-400">Choose a category above and start searching for your next adventure.</p>
        </div>
      </div>
    );
  };
