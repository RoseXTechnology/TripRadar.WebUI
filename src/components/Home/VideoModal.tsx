      ...
      >
        ...
        <div className="p-4 bg-gray-50 dark:bg-gray-700">
          <p className="text-gray-700 dark:text-gray-300 text-sm">
            This demo shows how to use our AI Travel Assistant via Telegram and WhatsApp for instant trip management, budget tracking, and personalized recommendations.
          </p>
        </div>
      </div>
    </div>
